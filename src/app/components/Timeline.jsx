  ...
  const data = [
    {
      ...
      content: (
        <div>
          <h1 className={`${greatVibes.className} text-4xl`}>Idea Submission and Presentation Round <br/><span className={`${born2b.className} text-5xl`}>(26 April)</span></h1>
          <p
            className={`${greatVibes.className} text-neutral-600 dark:text-neutral-200 text-xs md:text-lg font-normal mb-8`}>
            Idea Submission and Presentation Round 
            OnUnstop Logo
