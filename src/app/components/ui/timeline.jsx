...
export const Timeline = ({
  ...
  return (
    <div
      className="w-full  bg-white dark:bg-neutral-950 font-sans md:px-10 bg-gradient-to-r from-rose-400 to-orange-300 h-full"
      ref={containerRef}>
      ...
      <div ref={ref} className="relative max-w-7xl mx-30 pb-20 flex flex-col justify-center items-center">
        {data.map((item, index) => (
